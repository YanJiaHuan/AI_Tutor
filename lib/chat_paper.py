...
class Reader:
    ...
    def chat_method(self, text, method_prompt_token = 800):
        ...
        messages=[
                ...
                {"role": "user", "content": """                 
                 7. Describe the methodological ideas of this article as one word and explain it in details. Be sure to use {} answers (proper nouns need to be marked in English). For example, its steps are.
                    - (1):...
                    - (2):...
                    - (3):...
                    - .......
